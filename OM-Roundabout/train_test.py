...
import Roundabout_ENVS as IPPO_ENVS
...
parser.add_argument('--load_seed', default=1134, type=str) # seed
...
parser.add_argument('--update_interval', default=400, type=int) # 网络更新step间隔
...
parser.add_argument('--update_iteration', default = 30, type=int) # 网络迭代次数
    ...
    try:
        ...
        for i in range(args.max_episode):
            ...
            if i == 0:
                ...
                ego_end_location = ego_transform.location + carla.Location(x=-44.5,y=120)
                ...
                npc_end_location = npc_transform.location + carla.Location(x=-33.5,y=120)
            ...
            ego_state,_,_,npc_state,_,_,_,_,_,_ = create_envs.get_vehicle_step(ego_list[0], npc_list[0], egosen_list, npcsen_list, ego_route[ego_step], npc_route[npc_step], ego_route[ego_step+1], npc_route[npc_step+1], obstacle_list[0], ego_step, npc_step, ego_num, npc_num, 0)
            ...
            for t in range(999999999):
                ...
                ego_next_state,ego_reward,ego_done,npc_next_state,npc_reward,npc_done,egocol,ego_fin,npccol,npc_fin = create_envs.get_vehicle_step(ego_list[0], npc_list[0], egosen_list, npcsen_list, ego_route[ego_step], npc_route[npc_step], ego_route[ego_step+1], npc_route[npc_step+1], obstacle_list[0], ego_step, npc_step, ego_num, npc_num, t)
