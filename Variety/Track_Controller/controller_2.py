...
class VehiclePIDController2:
    ...
    def __init__(self, vehicle, args_lateral=None, args_longitudinal=None, args=None):
        """
...
class PIDLongitudinalController:
    ...
    def __init__(self, vehicle, K_P=10.0, K_D=0.0, K_I=0.0, dt = 0.05):
        """
        :param vehicle: actor to apply to local planner logic onto
...
class PIDCrossTrackController:
    ...
    def __init__(self, params, dt = 0.03):
        """
...
class IntelligentDriverModel:
    ...
    def __init__(self, vehicle, params=None, dt = 0.05):
